...
export default class PlayerVsComp extends React.Component {
  constructor(props) {
    super(props);
  ...
  onTilePress = (row, col) => {
    ...
    var humanPlayer = this.state.humanPlayer;

    var arr = this.state.gameState.slice();
    arr[row][col] = humanPlayer;
    this.setState({ gameState: arr });

    var toComputer = humanPlayer == 1 ? -1 : 1;
    this.setState({ humanPlayer: toComputer });
